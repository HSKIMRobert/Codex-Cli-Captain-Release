...
Use this guide for the Cargo-first `0.0.11` install surface.
...
1. download the pinned `v0.0.11` fallback bundle from the release page, or run the matching installer release asset
