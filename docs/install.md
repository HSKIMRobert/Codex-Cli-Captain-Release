...
Use this guide for the Cargo-first `0.0.2` install surface.
...
1. download the pinned `v0.0.2` bundle from the release repository, or run the matching installer script
