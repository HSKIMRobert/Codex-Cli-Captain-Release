...
Release-bundle fallback installers target `v0.0.8` and are published as release assets alongside
matching validated bundle assets. Cargo remains the primary `0.0.8` install
