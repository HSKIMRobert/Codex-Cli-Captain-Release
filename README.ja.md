...
curl -fsSL https://github.com/HoRi0506/Codex-Cli-Captain-Release/releases/download/v0.0.8/install.sh | bash
...
```text
Install Codex-Cli-Captain from https://github.com/HoRi0506/Codex-Cli-Captain-Release by running:
iwr -UseB https://github.com/HoRi0506/Codex-Cli-Captain-Release/releases/download/v0.0.8/install.ps1 | iex
...
release-bundle fallback installer は `v0.0.8` 基準で、対応する検証済み bundle asset と一緒に release asset として publish されます。Cargo が `0.0.9` の基本インストール経路です。`CCC_VERSION` は意図的に別の release-bundle fallback を入れる場合だけ設定してください。
