...
release-bundle fallback installer는 `v0.0.8` 기준이며, 매칭되는 검증 완료 bundle asset과 함께 release asset으로 publish됩니다. Cargo가 `0.0.8`의 기본 설치 경로입니다. `CCC_VERSION`은 의도적으로 다른 release-bundle fallback을 설치할 때만 설정하세요.
